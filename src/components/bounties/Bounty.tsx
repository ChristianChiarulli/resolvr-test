...
export default function Post({ bountyEvent }: Props) {
  ...
  return (
    <li className="flex cursor-pointer items-center gap-x-4 border-t p-4 hover:bg-muted">
      <img
        src={
          nq.profileContent(profileMap[pubkey]).picture || BOT_AVATAR_ENDPOINT
        }
        alt=""
